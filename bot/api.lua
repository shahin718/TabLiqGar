...
config_sudo = {529769525,476031528,467757340,177501908}
...
d:del("tgp")
d:del("tusers")
tabchi.sendText(msg.chat_id_, msg.id_,1,' 😉Ok,'md')
...
if is_sudo(msg) then
        if text == 'ارسال به سوپرگپ' and tonumber(msg.reply_to_message_id_) > 0 then
          function cb(a,b,c)
  ...
  if text == 'ارسال به گروه' and tonumber(msg.reply_to_message_id_) > 0 then
          function cb(a,b,c)
          local text = b.content_.text_
  ...
  if text == 'ارسال به کاربران' and tonumber(msg.reply_to_message_id_) > 0 and is_sudo(msg) then
          function cb(a,b,c)
          local text = b.content_.text_
...
local uu = d:scard("ausers")     
  ...
  if text == 'فروارد به سوپرگپ' and tonumber(msg.reply_to_message_id_) > 0 then
          function cb(a,b,c)
          local list = d:smembers('asgp')
          for k,v in pairs(list) do
...
if text == 'فروارد به گپ' and tonumber(msg.reply_to_message_id_) > 0 then
          function cb(a,b,c)
          local list = d:smembers('agp')
          for k,v in pairs(list) do
         tabchi.forwardMessages(v, msg.chat_id_, {[0] = b.id_}, 1)
...
if text == 'فروارد به کاربران' and tonumber(msg.reply_to_message_id_) > 0 then
          function cb(a,b,c)
          local list = d:smembers('ausers')
          for k,v in pairs(list) do
         tabchi.forwardMessages(v, msg.chat_id_, {[0] = b.id_}, 1)
